...
const parseDataBRParaISO = (dataStr) => {
    ...
    // Valida faixas para não gerar uma data inválida (ex.: "2024-13-45") que faria
    // o Postgres rejeitar o insert e abortar todo o upload por causa de uma célula ruim.
